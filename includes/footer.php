        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 md:py-4">
            <div class="flex flex-col md:flex-row justify-between items-center text-sm text-muted gap-4 md:gap-5">
                ...
                <div class="flex flex-wrap justify-center gap-4 md:gap-5 font-medium">
                    <a href="<?php echo BASE_URL; ?>auth/register.php?role=Seeker" class="transition-all duration-200 duration-300 focus:outline-none focus:underline">For Job Seekers</a>
                    <a href="<?php echo BASE_URL; ?>auth/register.php?role=Employer" class="transition-all duration-200 duration-300 focus:outline-none focus:underline">For Employers</a>
