...
function display_flash_messages() {
    ...
    foreach ($_SESSION['flash_messages'] as $flash) {
        ...
        echo '<button type="button" class="inline-flex rounded-md p-1.5 focus:outline-none focus:ring-2 focus:ring-offset-2 opacity-70 transition-opacity duration-300 ease-in-out ' . $btnClass . ' transition-all duration-200 active:scale-95" onclick="this.parentElement.remove();" aria-label="Dismiss alert">';
