...
<body class="bg-gray-50 text-gray-900 dark:bg-gray-950 dark:text-gray-100 transition-colors duration-200 min-h-screen flex flex-col font-sans tracking-tight">
    ...
    <header class="sticky top-0 z-50 w-full backdrop-blur-xl bg-white/75 dark:bg-gray-950/75 border-b border-gray-200/80 dark:border-white/10 shadow-sm transition-colors duration-300">
        <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between py-1.5" aria-label="Main Navigation">
            ...
            <a href="<?php echo BASE_URL; ?>index.php" class="flex items-center gap-1 text-lg font-bold text-gray-900 dark:text-white focus:outline-none focus-visible:ring-4 focus-visible:ring-blue-400 rounded-lg transition-all group leading-none">
                <span class="tracking-tight hidden sm:block">Equi<span class="text-blue-700 dark:text-blue-400">Work</span></span>
            </a>

            <div class="flex items-center gap-2 sm:gap-3">
                <button id="theme-toggle" type="button" class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 focus:outline-none focus-visible:ring-4 focus-visible:ring-blue-400/50 rounded-lg p-0.5 transition-all border border-transparent dark:hover:border-gray-700 flex items-center justify-center" aria-label="Toggle Dark Mode">
                ...
                <?php if (isset($_SESSION['user_id'])): ?>
                    ...
                    <?php if (isset($_SESSION['role']) && $_SESSION['role'] === 'Admin'): ?>
                        <a href="<?php echo BASE_URL; ?>admin/dashboard.php" class="text-sm font-semibold text-gray-700 dark:text-gray-300 hover:text-red-600 dark:hover:text-red-400 focus:outline-none focus:ring-4 focus:ring-red-300 rounded px-2 py-0.5 transition-colors whitespace-nowrap leading-none flex items-center">Admin Panel</a>
                    <?php else: ?>
                        <a href="<?php echo BASE_URL; ?>jobs.php" class="text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-blue-700 dark:hover:text-blue-400 focus:outline-none focus:ring-4 focus:ring-blue-400 rounded px-2 py-0.5 transition-colors whitespace-nowrap leading-none flex items-center">Available Roles</a>
                    <?php endif; ?>

                    <div class="h-4 w-px bg-gray-300 dark:bg-gray-700 hidden sm:block"></div>

                    <a href="<?php echo BASE_URL; ?>actions/logout.php" class="text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white focus:outline-none focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-700 rounded px-2 py-0.5 transition-colors whitespace-nowrap leading-none flex items-center">Log Out</a>
