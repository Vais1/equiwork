...
<body class="bg-bg text-text transition-colors duration-200 min-h-screen flex flex-col font-sans tracking-tight antialiased">
    ...
    <header class="sticky top-0 z-50 w-full backdrop-blur-md bg-bg/80 border-b border-border shadow-sm transition-colors duration-300">
        <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between py-3 md:py-4" aria-label="Main Navigation">
            ...
            <div class="flex items-center gap-2 sm:gap-3">
                <button id="theme-toggle" type="button" class="text-muted focus:outline-none focus-visible:ring-4 focus-visible:ring-accent/50 rounded-lg p-0.5 transition-all duration-300 ease-in-out border border-transparent flex items-center justify-center" aria-label="Toggle Dark Mode">
